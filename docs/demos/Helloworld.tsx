...
import { AmbientLight, BoxGeometry, Mesh, MeshPhongMaterial, PlaneGeometry, PointLight, Scene, SphereGeometry, WebGLRenderer } from 'three';
import { Proton, Emitter, Rate, Span, Mass, Radius, Life, Body, Position, BoxZone, Vector3D, Velocity, Rotate, Scale, Gravity, MeshRender, Debug } from 'particle';
...
export default () => {
  ...
  return <div className='wrap' style={{ height: '500px' }} ref={containerRef} />
};
...
class SceneManager {
  ...
  constructor(wrap: HTMLDivElement) {
       ...
       // 创建相机
       const camera = new THREE.PerspectiveCamera(70, rect.width / rect.height, 1, 10000);
